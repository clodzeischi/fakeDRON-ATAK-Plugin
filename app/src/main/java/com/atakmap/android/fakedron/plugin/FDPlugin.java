...
public class FDPlugin implements IPlugin {
    ...
    public FDPlugin(IServiceController serviceController) {
    ...
    private void showPane() {
        ...
        if(templatePane == null) {
            ...
            templatePane = new PaneBuilder(PluginLayoutInflater.inflate(pluginContext,
                    ...
                    // pane will take up 40% of screen width in landscape mode
                    .setMetaValue(Pane.PREFERRED_WIDTH_RATIO, 0.4D)
                    // pane will take up 40% of screen height in portrait mode
                    .setMetaValue(Pane.PREFERRED_HEIGHT_RATIO, 0.4D)
                    .build();
        }
